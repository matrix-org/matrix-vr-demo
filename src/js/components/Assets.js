    ...
    render() {
        return (
            <a-assets ref="assets" id='assets'>
                ...
                <span id='tourism'>
                    <video id='ski-video1'
                        src='https://matrix.org/vrdemo_resources/video/360/ski1.mpd'
                        muted crossOrigin></video>
                    <video id='ski-video2'
                        src='https://matrix.org/vrdemo_resources/video/360/ski2.mpd'
                        muted crossOrigin></video>
                    <video id='ski-video3'
                        src='https://matrix.org/vrdemo_resources/video/360/ski3.mpd'
                        muted crossOrigin></video>
                    <video id='ski-video4'
                        src='https://matrix.org/vrdemo_resources/video/360/ski4.mpd'
                        muted crossOrigin></video>
